...
A ``.env`` next to this script is loaded automatically.
"""
...
def _env_api_key() -> str:
    ...
    if not key:
        print(
            ...
            "Generate one at Profile -> API Access and export it, or put it in .env.",
            file=sys.stderr,
        )
        sys.exit(2)
    return key
...
def build_parser() -> argparse.ArgumentParser:
    ...
    # debate / explore share the same arg shape
